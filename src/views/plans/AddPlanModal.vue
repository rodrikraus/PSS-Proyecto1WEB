                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex-grow">
                            ...
                            <select multiple>
                                <option v-for="prestacion in selectedPrestaciones" :key="prestacion.id" :value="prestacion.id">
                                    {{ prestacion.nombre }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="flex-grow">
                            ...
                            <select multiple>
                                <option v-for="prestacion in prestacionesDisponibles" :key="prestacion.id" :value="prestacion.id">
                                    {{ prestacion.nombre }}
                                </option>
                            </select>
                        </div>
